...
Node.js + Express powers the backend, the frontend uses Handlebars templates, and the entire system is deployed on an Azure Ubuntu VM with Nginx acting as a reverse proxy.
